...
countries = [CountryInfo "Andorra" "Andorra la Vella" 468 ".ad" "Euro" images_flags_countries_Flag_of_Andorra_png,
             ...
             CountryInfo "Belgium" "Brussels" 30510 ".be" "Euro" images_flags_countries_Flag_of_Belguim_png,
             CountryInfo "Burkina Faso" "Ouagadougou" 274200 ".bf" "Franc" images_flags_countries_Flag_of_Burkino_Faso_png,
             ...
             CountryInfo "Saint Barthélemy" "Gustavia" 21 ".gp" "Euro" images_flags_countries_Flag_of_Saint_Barthelemy__local_png,
             ...
             CountryInfo "Bahamas" "Nassau" 13940 ".bs" "Dollar" images_flags_countries_Flag_of_Bahamas_png,
             CountryInfo "Bhutan" "Thimphu" 47000 ".bt" "Ngultrum" images_flags_countries_Flag_of_Bhutan_png,
             CountryInfo "Bouvet Island" "" (- 1)  ".bv" "Krone" UNKNOWN,
             ...
             CountryInfo "Cocos Islands" "West Island" 14 ".cc" "Dollar" images_flags_countries_Flag_of_Cocos__Keeling_Islands_png,
             ...
             CountryInfo "Ivory Coast" "Yamoussoukro" 322460 ".ci" "Franc" UNKNOWN,
             ...
             CountryInfo "China" "Beijing" 9596960 ".cn" "Yuan Renminbi" images_flags_countries_Flag_of_the_People_s_Republic_of_China_png,
             CountryInfo "Colombia" "Bogotá" 1138910 ".co" "Peso" images_flags_countries_Flag_of_Columbia_png,
             ...
             CountryInfo "Dominica" "Roseau" 754 ".dm" "Dollar" images_flags_countries_Flag_of_Dominca_png,
             ...
             CountryInfo "Ethiopia" "Addis Ababa" 1127127 ".et" "Birr" images_flags_countries_Flag_of_Ethopia_png,
             ...
             CountryInfo "French Guiana" "Cayenne" 91000 ".gf" "Euro" images_flags_countries_Flag_of_French_Guiana_png,
             ...
             CountryInfo "Gibraltar" "Gibraltar" 6 ".gi" "Pound" images_flags_countries_Flag_of_Gibralter_png,
             CountryInfo "Greenland" "Nuuk" 2166086 ".gl" "Krone" images_flags_countries_Flag_of_Greenland_png,
             CountryInfo "Gambia" "Banjul" 11300 ".gm" "Dalasi" images_flags_countries_Flag_of_Gambia_png,
             ...
             CountryInfo "Heard Island and McDonald Islands"  "" 412 ".hm" "Dollar" UNKNOWN,
             CountryInfo "Honduras" "Tegucigalpa" 112090 ".hn" "Lempira" images_flags_countries_Flag_of_Honduras_png,
             CountryInfo "Croatia" "Zagreb" 56542 ".hr" "Kuna" images_flags_countries_Flag_of_Crotia_png,
             ...
             CountryInfo "Isle of Man" "Douglas  Isle of Man" 572 ".im" "Pound" images_flags_countries_Flag_of_Isle_of_Man_png,
             ...
             CountryInfo "Comoros" "Moroni" 2170 ".km" "Franc" images_flags_countries_Flag_of_Comoros_png,
             ...
             CountryInfo "Marshall Islands" "Majuro" 181 ".mh" "Dollar" images_flags_countries_Flag_of_Marshall_Islands_png,
             ...
             CountryInfo "Macao" "Macao" 254 ".mo" "Pataca" images_flags_countries_Flag_of_Macao_png,
             ...
             CountryInfo "Martinique" "Fort-de-France" 1100 ".mq" "Euro" images_flags_countries_Flag_of_Marinique_png,
             CountryInfo "Mauritania" "Nouakchott" 1030700 ".mr" "Ouguiya" images_flags_countries_Flag_of_Mauritiania_png,
             CountryInfo "Montserrat" "Plymouth" 102 ".ms" "Dollar" images_flags_countries_Flag_of_Monserrat_png,
             ...
             CountryInfo "Norfolk Island" "Kingston" 35 ".nf" "Dollar" images_flags_countries_Flag_of_the_Norfolk_Islands_png,
             ...
             CountryInfo "Netherlands" "Amsterdam" 41526 ".nl" "Euro" images_flags_countries_Flag_of_Netherlands_png,
             ...
             CountryInfo "Philippines" "Manila" 300000 ".ph" "Peso" images_flags_countries_Flag_of_Philippines_png,
             ...
             CountryInfo "Pitcairn" "Adamstown" 47 ".pn" "Dollar" images_flags_countries_Flag_of_Pitcairn_png,
             ...
             CountryInfo "Solomon Islands" "Honiara" 28450 ".sb" "Dollar" images_flags_countries_Flag_of_the_Solomon_Isoaldsn_png,
             CountryInfo "Seychelles" "Victoria" 455 ".sc" "Rupee" images_flags_countries_Flag_of_Seychelles_png,
             ...
             CountryInfo "Saint Helena" "Jamestown" 410 ".sh" "Pound" images_flags_countries_Flag_of_Saint_Helens_png,
             CountryInfo "Slovenia" "Ljubljana" 20273 ".si" "Euro" images_flags_countries_Flag_of_Slovenia_png,
             CountryInfo "Svalbard and Jan Mayen" "Longyearbyen" 62049 ".sj" "Krone" images_flags_countries_Flag_of_, 
             ...
             CountryInfo "United States Minor Outlying Islands"  "" 0 ".um" "Dollar" images_flags_countries_Flag_of_,
             ...
             CountryInfo "Saint Vincent and the Grenadines" "Kingstown" 389 ".vc" "Dollar" images_flags_countries_Flag_of_Sain,
             ...
             CountryInfo "Mayotte" "Mamoudzou" 374 ".yt" "Euro" images_flags_countries_Flag_of_Mayotte_(local)_png,
