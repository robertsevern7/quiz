...
questions = [
  ...
  ("What is the SI unit for time?", "Second (Minutes/Hours/Days etc are all incorrect, they are derived from seconds)"),
  ("For which two films did Steven Spielberg win the Best Director Oscar?", "Schindler's List and Saving Private Ryan"),
  ...
  ("Who designed the spectacular Church of the Holy Family and the Casa Mila block of flats, both in Barcelona?", "Antonio Gaudi"),
  ...
  ("Who wrote Tarzan of the Apes in 1912?", "Edgar Rice Burroughs"),
  ...
  ("Who wrote the novel Chitty Chitty Bang Bang : The Magical Car?", "Ian Fleming (he was more famous for James Bond)"),
  ...
  ("Which of these countries does NOT border the Russian Federation a)Georgia b)Armenia C)Azerbaijan D)Latvia?", "b) Armenia"),
  ...
  ("In physics, what letter is used to represent to fundamental constant that is equal to \"9.80665 metres per second squared\"?", "g (constant is Earth's gravity pull, the acceleration of free fall)"),
  ...
  ("At which battle on August 1st 1798 did Nelson destroy the French fleet, 7 years before doing it again at the Battle of Trafalgar?", "Battle of the Nile (also known as the Battle of Aboukir Bay)"),
  ...
  ("The Gobi desert covers territory in which two countries?", "China and Mongolia"),
  ...
  ("What is the longest river in Asia?", "Yangtze (known as Chang Jiang in Chinese) Note: completely different river from the Yellow River!"),
  ...
  ("How many players in total are on the field at the start of a regular game of Gaelic Football?", "30 (15 each side)"),
  ...
  ("What is the deepest lake in the world, with depths over 1,600 metres?", "Baikal (Baykal)"),
  ...
  ("What were the names of the three ships Christopher Columbus led, in his discovery of the Americas in 1492?", "Santa Maria, Pinta and Nina"),
  ...
  ("When Neil Armstrong stepped onto the moon and said his famous pre-written line, he missed out an important word. What word was it?", "a (He was supposed to say \"One small step for A man, one giant leap for mankind\")"),
  ("Who won the Nobel Prize for physics in 1901 for discovering X-Rays?", "Rontgen"),
  ("How is Nitrous Oxide better known?", "Laughing gas"),
  ("Which British duo were the first people to fly across the Atlantic Ocean non-stop?", "Alcock and Brown"),
  ...
  ("Who was the second man to step foot on the surface of the moon?", "Edwin 'Buzz' Aldrin"),
